...
export default {
  data() {
    return {
      projects: [
        {
          title: 'Svelte Weather',
          text: 'A simple weather app built with svelte',
          img: 'svelte_weather.png',
          code: 'https://github.com/rhall1310/svelte-weather',
          link: 'https://svelte-weather-rh1310-dev.netlify.app/',
